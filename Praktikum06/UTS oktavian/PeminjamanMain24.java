...
public class PeminjamanMain24 {
    ...
    public static void main(String[] args) {
        ...
        //mengisi atribut isCanceled setelah di buat di class
        mhs[0] = new Mahasiswa24("22001", "Andi", "Teknik Informatika", false);
        mhs[1] = new Mahasiswa24("22002", "Budi", "Teknik Informatika", false);
        mhs[2] = new Mahasiswa24("22003", "Citra", "Sistem Informasi Bisnis", false);
        ...
        Pinjam[0] = new Peminjaman24(mhs[0], Databuku[0], 20);
                ...
                case 5:
                    ...
                    for (int i = 0; i < Pinjam.length; i++) {
                        if (Pinjam[i].mhs.nim.equals(NimMhs)){
                            //jawaban sesi 4 b, jika nim yang dicari ada maka atribut iscanceled nya akan menjadi true dan selain nim itu akan dicetak
                            Pinjam[i].mhs.isCanceled = true;
                            } else {
                                Pinjam[i].tampilPeminjaman();
                            }
                    }
